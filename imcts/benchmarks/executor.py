...
# 100 seeds from the ANU Quantum Random Number Generator (quantum vacuum
# fluctuations). Fetched 2026-05-13 via https://quantumnumbers.anu.edu.au
# as 200 uint16 values, combined pairwise into uint32: (hi << 16) | lo.
QUANTUM_SEEDS = [
    723072574, 971434279, 3325160576, 3163586042, 1227433701,
    2057259013, 3814845113, 2770303473, 3183815639, 3828183215,
    2437489881, 2218870180, 1677402687, 310923819, 1777581980,
    354449225, 1949615811, 2845477618, 3334804072, 3003924095,
    938757074, 3434952867, 2073228580, 1668493585, 3850872759,
    2537996840, 3995401709, 3994838759, 861316294, 2169555080,
    758553822, 1393567789, 540967856, 902677639, 2191321948,
    1851676975, 1139067352, 1305444561, 1869174399, 2928440539,
    4027297405, 3926696696, 3747793057, 837591013, 2366855942,
    3465266528, 323105323, 3059174495, 1796736039, 4080976823,
    1129862598, 2501308237, 2872581883, 2157573201, 1287263512,
    1830868652, 3383119910, 646788872, 3169893663, 314500441,
    1881455519, 2621623777, 4135381994, 2643969318, 2172690349,
    534831994, 2701542408, 3905278380, 2580222673, 864589219,
    2499012356, 1980462661, 2452680695, 3630032764, 4174106357,
    867240961, 1596437698, 3765576040, 1820974996, 23958531,
    3823501306, 2654901646, 3259510512, 950346302, 1436364170,
    1570424568, 4035782163, 2538244260, 741423123, 4203616987,
    1451685539, 3089837783, 2706151228, 2970813244, 172779871,
    2754163514, 3294841411, 3184510963, 1468460158, 972782567,
]

SEED_LISTS = {
    "srbench": MCTS_4_SR_SEEDS,
...
def seed_for_run(seed_start: int, run_index: int, seed_source: str = "srbench") -> int:
    seeds = SEED_LISTS[seed_source]
    return seeds[(seed_start + run_index) % len(seeds)]
